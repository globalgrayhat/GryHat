...
const StudentLoginModal: React.FC<StudentLoginModalProps> = ({
  ...
  const handleSubmit = async (
    studentInfo: { email: string; password: string },
    ...
    try {
      ...
      toast.error(
        (error as { response?: { data?: { message?: string } } })?.response
          ?.data?.message || t("toast.loginFailed")
      );
    } finally {
