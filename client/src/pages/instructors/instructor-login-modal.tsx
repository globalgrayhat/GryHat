  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-[100] p-4" onClick={onClose}>
        <div className="relative w-full max-w-4xl max-h-[95vh] bg-white dark:bg-gray-800 rounded-2xl shadow-2xl flex flex-col md:flex-row overflow-hidden" onClick={e => e.stopPropagation()}>
            <button onClick={onClose} className="absolute z-20 text-gray-400 top-4 right-4 hover:text-gray-500"><XMarkIcon className="w-6 h-6" /></button>
            
            {/* Left Decorative Column */}
            <div className="flex-col items-center justify-center hidden p-8 md:flex md:w-1/3 bg-gray-50 dark:bg-gray-900/50">
            ...
            {/* Right Form Column */}
            <div className="flex flex-col justify-center w-full p-8 overflow-y-auto md:w-2/3 sm:p-12">
                <Formik 
                  ...
                  {() => (
                    <Form className="w-full max-w-md mx-auto">
                      <div className="mb-8 text-center">
                        ...
                        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">{t('login.subtitle') || 'Access your dashboard'}</p>
                      </div>
                      ...
                      <div className="mt-8">
                          <button type="submit" className={primaryButtonStyle} disabled={isSubmitting}>
                              {isSubmitting && <svg className="w-5 h-5 mr-3 -ml-1 text-white animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>}
