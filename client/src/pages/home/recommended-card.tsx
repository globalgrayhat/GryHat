...
/* ---------- Tolerant fields ---------- */
type RecommendedCardData = ApiResponseRecommended & {
  price?: number;
  rating?: number;
...
interface Props {
  courseInfo: RecommendedCardData;
}
...
/* ---------- Instructor pin (name LEFT, avatar RIGHT) ---------- */
  ...
  >
    <span
      className={[
        ...
        // Light chip; dark high-contrast chip
...
const RecommendedCard: React.FC<Props> = ({ courseInfo }) => {
  ...
  // Resolve media URLs and basic flags
    ...
    >
      ...
      <CardHeader floated={false} shadow={false} color="transparent" className="m-0 p-0">
        <div className="relative aspect-[16/9] w-full overflow-hidden">
          ...
          {/* Overlay: subtle in light; stronger in dark for readability */}
          ...
          {/* Top-left badges: Category + Price (colored in dark) */}
