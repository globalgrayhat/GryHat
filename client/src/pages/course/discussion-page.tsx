...
} from "../../api/endpoints/course/discussion";
...
const Discussion: React.FC<{ lessonId: string }> = ({ lessonId }) => {
  ...
  const visibleCommentsList = useMemo(
    () => discussions?.slice(0, visibleCount) ?? [],
    [discussions, visibleCount]
  );
      ...
      <CardBody className="p-4 sm:p-6">
        ...
        <div className="mb-3 sm:mb-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Typography
              variant="h6"
              className="!m-0 text-gray-900 dark:text-white text-base sm:text-lg"
            >
              Lesson Discussion
            </Typography>
            <Chip
